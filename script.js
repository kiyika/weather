let key = "f49f868cd22ac57070239f2464d200ca"//"<< API Key from openweathermap.org >>
var cityName = "";
var link = "";
var link_trend = "";
var link_time = "";
...
function getWeather(weather){
    if(weather == "Haze"){
        if(time<18 && time>6)
            ...
            return "image/cloudy-night-1.svg"
    }
    else if(weather == "Clouds"){
        return "image/cloudy.svg"
    }
...
function getLocation() {
    if (navigator.geolocation) {
        ...
        document.getElementById('nointernet').innerHTML = "Please check if your Location is enabled."
    }
}
